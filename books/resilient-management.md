...
- [Meet your team](#meet-your-team)
  - [Core Needs At Work](#core-needs-at-work)
  - [Work style and preferences](#work-style-and-preferences)
  - [Help the Team Get to Know You Better](#help-the-team-get-to-know-you-better)
 ...
 * This page is organized according to [these](https://github.com/keyvanakbary/learning-notes/blob/master/books/resilient-management.md) notes with small changes. Thanks [Keyvan Akbary](https://github.com/keyvanakbary)

## Meet your team 

One of your primary jobs is to foster a foundation of trust on your team. To foster trust, you've gotta start by understanding each person's needs, preferences and approaches to work.
...
* **Equality/fairness**, boils down the idea that your environment includes equal access to resources, information, and support for everyone in it. When this doesn't happen (or there's a perception that doesn't happen), people take to the streets and revolt.
...
Beside learning about individuals' core needs, it can be really helpful to gather insights about each teammate's growth areas, preferences about feedback and recognition, and other aspects of their work.

You can ask a list of simple questions to your teammates in your first 1:1 together.[A template](https://docs.google.com/document/d/1ALVJFA8gp7H53iIyPQqoBN1IvZku-5YYcjKpMx6HCXE).
...
Getting known better by the team develops better working relationships.

Ask yourself "What are you optimizing for"? and share the answers with your teammaters.

Your leadership philosophy should be "optimize for long-term relationships"
...
If you have a mentee who _is_, be aware of the way members of underrepresented groups are perceived. Make sure that your advice is going to be helpful in practice for your mentee.
...
* The team's mission or priorities
* How teammates should be collaborating, communicating, and shipping work

### Roles and responsibilities

Clarity typically comes in the form of documentation like a career ladder. Document the responsibilities of each person or role, and how those responsibilities intersect.

You can use two tools to nail down specifics, the assignment matrix and Venn diagram.
...
A recommendation for these diagrams is re-visit them every six months or so by answering some questions like:
  * _What is not working?_
  * _What should stay same?_
  * _What responsibilities have been added to your plates?_
...
* **Meetings**: Identify all of the meetings. Write down the purpose, frequency, and participants. Add descriptions so potential attendees decide which meetings are important to attend, which might be _interesting_ to attend, and which they can probably skip.
...
When you need ot deliver a critical new message, it's a good idea to prepare a _communications plan_ a step-by-step strategy for sharing new information throughout an organization.
